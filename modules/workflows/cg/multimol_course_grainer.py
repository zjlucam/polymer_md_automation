...
from modules.open_mscg.multimol_traj_mapper import MultimolOpenMSCGTrajectoryMapper
from modules.open_mscg.force_matcher import OpenMSCGForceMatcher
from modules.open_mscg.multimol_topol_exporter import MultimolOpenMSCGTopolExporter
...
class MultimolCourseGrainer(BaseWorkflow):
    map_name = "cg_mapping"
    topol_name = "cg_topol"
    traj_name = "cg_traj"
    ...
    def run(self) -> str:
        self.traj_mapper = MultimolOpenMSCGTrajectoryMapper(
            ...
            sol_to_bead_ratio=self.sol_to_bead_ratio,
        )
        ...
        self.topol_exporter = MultimolOpenMSCGTopolExporter(
