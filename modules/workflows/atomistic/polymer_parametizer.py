...
class PolymerGeneratorWorkflow(BaseWorkflow):
    ...
    def _build_long_polymer(self, output_dir: str, pdb_output_dir: str = TEMP_DIR) -> GromacsPaths:
    ...
    def check_long_polymer_cache(self) -> Tuple[Optional[GromacsPaths], Optional[GromacsPaths]]:
...
class PolymerGeneratorWorkflow2(BaseWorkflow):
    box_dim_padding: float = 0.1
