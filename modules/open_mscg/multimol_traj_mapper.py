from modules.cg_mappers.multimol_map_generator import MultimolOpenMSCGMapGenerator
...
class MultimolOpenMSCGTrajectoryMapper:
    ...
    def __init__(
        ...
        self.map_generator: MultimolOpenMSCGMapGenerator = MultimolOpenMSCGMapGenerator(
            polymer=polymer,
            gro_file=gro_file,
